...
<div class="row membership">
	...
	?>
		<div class="<?php echo $level_cols; ?> columns">
			<ul class="pricing-table kleo-level-<?php echo $level->id; ?><?php if ( $popular == $level->id ) {
				echo ' popular';
			} ?>">
	...
	<div class="nav-previous alignleft">
		<?php if ( ! empty( $current_user->membership_level->ID ) ) { ?>
			<a href="<?php echo pmpro_url( "account" ) ?>"
			   class="small radius button link-button"><?php _e( '&larr; Return to Your Account', 'pmpro' ); ?></a>
		<?php } else { ?>
			<a href="<?php echo home_url() ?>"
			   class="small radius button link-button"><?php _e( '&larr; Return to Home', 'pmpro' ); ?></a>
		<?php } ?>
	</div>
	<br>&nbsp;<br><br>
</nav>