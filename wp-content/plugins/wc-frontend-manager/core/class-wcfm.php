...
class WCFM {
	...
	static function update_wcfm() {
		...
		if( !get_option( 'wcfm_updated_2_6_2' ) ) {
			
			require_once ( $WCFM->plugin_path . 'helpers/class-wcfm-install.php' );
			$WCFM_Install = new WCFM_Install();
			
			// Create Knowledge post for existing ones
			$wcfm_knowledgebase = get_option( 'wcfm_knowledgebase' );
			if( $wcfm_knowledgebase ) {
				register_post_type( 'wcfm_knowledgebase', array( 'public' => false ) );
				$new_group = array(
					'post_title'   => __( 'Guidelines for Store Users', 'wc-frontend-manager' ),
					'post_status'  => 'publish',
					'post_type'    => 'wcfm_knowledgebase',
					'post_content' => $wcfm_knowledgebase
				);
			}
			
			delete_option( 'wcfm_updated_2_4_7' );
			update_option( 'wcfm_updated_2_6_2', 1 );
		}
	}
	...
	function wcfm_color_setting_options() {
		...
		$color_options = apply_filters( 'wcfm_color_setting_options', array( 'wcfm_field_base_highlight_color' => array( 'label' => __( 'Base Highlighter Color', 'wc-frontend-manager' ), 'name' => 'wc_frontend_manager_base_highlight_color_settings', 'default' => '#00897b', 'element' => 'div.wcfm-collapse-content h2, #wcfm_page_load .fa, .wcfm_header_panel a:hover, .wcfm_header_panel a.active, ul.wcfm_products_menus li a, .wcfm-container-box .wcfm-container .booking_dashboard_section_icon, .wcfm_bookings_gloabl_settings, .fields_collapser, .wcfm_gloabl_settings, .wcfm_screen_manager_dummy, .wcfm_screen_manager, .woocommerce-reports-wide .postbox div.stats_range ul li.active a, .wcfm_reports_menus li a, .sales_schedule, .woocommerce-exporter-wrapper .wc-progress-form-content .woocommerce-importer-done::before, .woocommerce-exporter-wrapper .woocommerce-exporter .woocommerce-importer-done::before, .woocommerce-exporter-wrapper .woocommerce-importer .woocommerce-importer-done::before, .woocommerce-importer-wrapper .wc-progress-form-content .woocommerce-importer-done::before, .woocommerce-importer-wrapper .woocommerce-exporter .woocommerce-importer-done::before, .woocommerce-importer-wrapper .woocommerce-importer .woocommerce-importer-done::before, .woocommerce-progress-form-wrapper .wc-progress-form-content .woocommerce-importer-done::before, .woocommerce-progress-form-wrapper .woocommerce-exporter .woocommerce-importer-done::before, .woocommerce-progress-form-wrapper .woocommerce-importer .woocommerce-importer-done::before, .woocommerce-exporter-wrapper .wc-progress-steps li.done, .woocommerce-importer-wrapper .wc-progress-steps li.done, .woocommerce-progress-form-wrapper .wc-progress-steps li.done, .woocommerce-exporter-wrapper .wc-progress-steps li.active, .woocommerce-importer-wrapper .wc-progress-steps li.active, ul.wcfm_orders_menus li a, ul.wcfm_bookings_menus li a, .wc_bookings_calendar_form .wc_bookings_calendar td .bookings ul li a strong, .wc_bookings_calendar_form .tablenav .views a, .wc_bookings_calendar_form .tablenav .date_selector a, ul.wcfm_appointments_menus li a, .wcfm-container-box .wcfm-container .appointment_dashboard_section_icon, .wcfm_appointment_gloabl_settings, .wc_appointments_calendar_form .wc_appointments_calendar td .appointments ul li a strong, .wc_appointments_calendar_form .calendar_wrapper ul li a strong, .wc_appointments_calendar_form .tablenav .views a, .wc_appointments_calendar_form .tablenav .date_selector a, .mapp-m-panel a, .woocommerce-reports-wide .postbox div.stats_range ul li.custom.active, .sub_checklist_toggler', 'style' => 'color', 'element2' => '.woocommerce-exporter-wrapper .wc-progress-steps li.active::before, .woocommerce-importer-wrapper .wc-progress-steps li.active::before, .woocommerce-progress-form-wrapper .wc-progress-steps li.active::before, .woocommerce-exporter-wrapper .wc-progress-steps li.done::before, .woocommerce-importer-wrapper .wc-progress-steps li.done::before, .woocommerce-progress-form-wrapper .wc-progress-steps li.done::before,  .woocommerce-exporter-wrapper .wc-progress-steps li.done::before, .woocommerce-importer-wrapper .wc-progress-steps li.done::before, .woocommerce-progress-form-wrapper .wc-progress-steps li.done::before, .woocommerce-exporter-wrapper .wc-progress-steps li.done, .woocommerce-importer-wrapper .wc-progress-steps li.done, .woocommerce-progress-form-wrapper .wc-progress-steps li.done, .woocommerce-exporter-wrapper .wc-progress-steps li.active, .woocommerce-importer-wrapper .wc-progress-steps li.active, .wcfm_vacation_msg, a.add_new_wcfm_ele_dashboard:hover, a.wcfm_import_export:hover', 'style2' => 'background-color', 'element3' => '.woocommerce-reports-wide .button:hover, #mapp_e_search, #wcfm_quick_edit_button:hover, #wcfm_screen_manager_button:hover, .woocommerce-exporter-wrapper .wc-progress-steps li.done::before, .woocommerce-importer-wrapper .wc-progress-steps li.done::before, .woocommerce-progress-form-wrapper .wc-progress-steps li.done::before, .wcfm_admin_message .primary:hover, input.wcfm_submit_button:hover, .wcfm_add_attribute:hover, input.upload_button:hover, input.remove_button:hover, .multi_input_block_manupulate:hover', 'style3' => 'background' ),
																																				 'wcfm_field_menu_bg_color' => array( 'label' => __( 'Menu Background Color', 'wc-frontend-manager' ), 'name' => 'wc_frontend_manager_menu_bg_color_settings', 'default' => '#cccccc', 'element' => '#wcfm_menu', 'style' => 'background' ),
