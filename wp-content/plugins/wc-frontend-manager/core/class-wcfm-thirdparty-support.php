...
class WCFM_ThirdParty_Support {
  ...
  /**
	...
	function wcfm_yithauction_free_product_manage_fields( $product_id = 0, $product_type ) {
		...
		?>
		<div class="page_collapsible products_manage_yithauction_free auction non-variable-subscription" id="wcfm_products_manage_form_yithauction_free_head"><label class="fa fa-gavel"></label><?php _e('Auction', 'wc-frontend-manager'); ?><span></span></div>
