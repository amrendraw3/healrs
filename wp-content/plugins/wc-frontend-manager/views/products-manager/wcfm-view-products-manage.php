...
<div class="collapse wcfm-collapse" id="">
  <div class="wcfm-page-headig">
	...
	<div class="wcfm-collapse-content">
		...
		if( $product_id ) {
		  ?>
		  <span class="product-status product-status-<?php echo $wcfm_products_single->post_status; ?>"><?php if( $wcfm_products_single->post_status == 'publish' ) { echo 'Published'; } else { echo ucfirst( $wcfm_products_single->post_status ); } ?></span>
		  <?php
