	  ...
	  <div id="wcfm_page_load"><i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i></div>
		...
		<form id="wcfm_settings_form" class="wcfm">
				...
				<div id="wcfm_settings_dashboard_expander" class="wcfm-content">
					<?php
						$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_settings_fields_style', array(
																																															...
																																															"wcfm_quick_access_icon" => array('label' => __('Quick access', 'wc-frontend-manager') , 'type' => 'upload', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title', 'prwidth' => 75, 'value' => $quick_access_image_url ),
			...
			<div class="page_collapsible" id="wcfm_settings_form_analytics_head">
				<label class="fa fa-line-chart"></label>
				<?php _e('Analytics', 'wc-frontend-manager'); ?><span></span>
			</div>
			<div class="wcfm-container">
				...
				<?php
						$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_settings_fields_analytics', array(
																																															"analytics_disabled" => array('label' => __('Disable Analytics', 'wc-frontend-manager') , 'name' => 'analytics_disabled','type' => 'checkbox', 'class' => 'wcfm-checkbox wcfm_ele', 'value' => 'yes', 'label_class' => 'wcfm_title checkbox_title', 'dfvalue' => $is_analytics_disabled),
																																															) ) );
